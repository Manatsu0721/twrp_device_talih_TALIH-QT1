...
$(call inherit-product, device/talih/TALIH_QT1/device.mk)

PRODUCT_DEVICE := TALIH_QT1
PRODUCT_NAME := omni_TALIH_QT1
PRODUCT_BRAND := talih
PRODUCT_MODEL := TALIH_QT1
PRODUCT_MANUFACTURER := talih

PRODUCT_GMS_CLIENTID_BASE := android-talih

PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="TALIH_QT1"
